...
void calculateDistance()
{
    ...
    //Calculates digital reading back to analog voltage value
     analogVoltage = adcReading * (3.3 / 4096);    // Vref = 3.3V, and ADC is 12 Bits
  
    //Calculates Distance; hope to implement more efficient formula
     distance = (6787/(analogVoltage -3) - 4);    // add condition to verify that division by zero does not occur (?)
...

{
  ...
  case 2:                                   // Vector 2 - RXIFG
    ...
    distance = UCA1RXBUF;                   // Sends calculated Distance value to UART
    break;
